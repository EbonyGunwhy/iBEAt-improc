...
if __name__=='__main__':
    source_dir = os.path.join("C:\\Users", "md1spsx", "Documents", 'GitHub', 'iBEAt-improc', 'build', 'dixon_2_data', 'Sheffield')
    target_dir = os.path.join("G:\\Shared drives", "iBEAt Build", "dixon_2_data", 'Sheffield')
